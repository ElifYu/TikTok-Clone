...
import 'package:tiktok_clone/controllers/chat/firebase_storage_repository.dart';
      ...
      for (var document in event.docs) {
        ...
        contacts.add(
          ChatContact(
            ...
            deviceToken: chatContact.deviceToken
          ),
        );
      }
      return contacts;
...
// users -> reciever user id => chats -> current user id -> set data
      var recieverChatContact = ChatContact(
        ...
        timeSent: timeSent,
        lastMessage: text,
        deviceToken: senderUserData.userDeviceToken
      );
      await firestore
          .collection('users')
          .doc(recieverUserId)
      ...
      var senderChatContact = ChatContact(
        ...
        timeSent: timeSent,
        lastMessage: text,
        deviceToken: recieverUserData.userDeviceToken
      );
      await firestore
          .collection('users')
          .doc(auth.currentUser!.uid)
